...
void list(void) {
    ...
    IOCTL_REQUEST(UBI_IOCMKVOL);
    IOCTL_REQUEST(UBI_IOCRMVOL);
    IOCTL_REQUEST(UBI_IOCRSVOL);
    IOCTL_REQUEST(UBI_IOCRNVOL);
    IOCTL_REQUEST(UBI_IOCRPEB);
    IOCTL_REQUEST(UBI_IOCSPEB);

    IOCTL_REQUEST(UBI_IOCATT);
    IOCTL_REQUEST(UBI_IOCDET);

    IOCTL_REQUEST(UBI_IOCVOLUP);
    IOCTL_REQUEST(UBI_IOCEBER);
    IOCTL_REQUEST(UBI_IOCEBCH);
    IOCTL_REQUEST(UBI_IOCEBMAP);
    IOCTL_REQUEST(UBI_IOCEBUNMAP);
    IOCTL_REQUEST(UBI_IOCEBISMAP);
    IOCTL_REQUEST(UBI_IOCSETVOLPROP);
    IOCTL_REQUEST(UBI_IOCVOLCRBLK);
    IOCTL_REQUEST(UBI_IOCVOLRMBLK);
}
