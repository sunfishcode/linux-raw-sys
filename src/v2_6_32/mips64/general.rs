...
pub const TIOCGHAYESESP: u32 = 21651;
pub const TIOCSHAYESESP: u32 = 21652;
pub const NCC: u32 = 8;
...
pub const __NR_O32_Linux_syscalls: u32 = 334;
...
pub const __NR_Linux_syscalls: u32 = 293;
pub const __NR_64_Linux: u32 = 5000;
pub const __NR_64_Linux_syscalls: u32 = 293;
pub const __NR_N32_Linux: u32 = 6000;
pub const __NR_N32_Linux_syscalls: u32 = 297;
...
pub type __kernel_nlink_t = ::std::os::raw::c_uint;
...
pub f_spare: [::std::os::raw::c_long; 6usize],
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct statfs64 {
